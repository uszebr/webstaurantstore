...
public class SearchResultPage extends BasePage {
    ...
    public boolean checkProductTitlesOnCurrentSearchPage(String searchText, String matchingText) {// true if all items on current page contains matching text;
        ...
        List<WebElement> listOfProductElements = getProductsListOnCurrentSearchPage(searchText);
    ...
    public List<WebElement> getProductsListOnCurrentSearchPage(String searchText) {// I need it in case we want to click every element and check each product page
    ...
    public boolean checkProductTitlesOnALLSearchPages(String searchText, String matchingText) {// true if all items on All pages contain matching text;
        boolean resultAllPages = true;

        do {
            System.out.println("Checking Search Results, Page: " + pageNumber);
            //check results on current page;
            if (!checkProductTitlesOnCurrentSearchPage(searchText, matchingText)) {
    ...
    public void addToCartLastProductOnCurrentPage(){
